{{-- resources/views/student/medical-records/edit.blade.php --}}
@extends('layouts.app')

@section('title', 'Edit My Medical Record')
...
<div class="min-h-screen bg-gray-50 py-6">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if(!$medicalRecord)
            <div class="bg-red-50 border border-red-200 rounded-xl p-4 mb-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-red-800">Medical record not found</h3>
                        <p class="text-sm text-red-600 mt-1">Redirecting to medical records...</p>
                    </div>
                </div>
            </div>
            <script>
                setTimeout(() => {
                    window.location.href = "{{ route('student.medical-records.index') }}";
                }, 2000);
            </script>
            @return
        @endif

        @if($medicalRecord->is_auto_created ?? false)
            <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">Complete your medical record</h3>
                        <p class="text-sm text-blue-600 mt-1">Redirecting to create your medical record...</p>
                    </div>
                </div>
            </div>
            <script>
                setTimeout(() => {
                    window.location.href = "{{ route('student.medical-records.create') }}";
                }, 2000);
            </script>
            @return
        @endif
        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div class="flex-1">
                    ...
                    <p class="text-gray-600 mt-2 text-sm sm:text-base">Update your health information and medical history</p>
                </div>
                <div class="flex items-center space-x-3">
                    <a href="{{ route('student.medical-records.index', $medicalRecord) }}" 
                       class="flex items-center justify-center sm:justify-start bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 font-medium py-2.5 px-4 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md text-sm sm:text-base">
                        ...
                        <span class="hidden sm:inline">Back to Record</span>
                ...
                <div class="ml-3 flex-1">
                    ...
                    <div class="mt-2 text-sm text-blue-700">
                        <ul class="list-disc pl-5 space-y-1">
                            ...
                            <li>After updating your record, please visit the clinic for verification if there are significant changes</li>
        ...
        <form action="{{ route('student.medical-records.update', $medicalRecord) }}" method="POST" class="space-y-6">
            @csrf
            @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <select name="blood_type" id="blood_type"
                                ...
                                <option value="A+" {{ old('blood_type', $medicalRecord->blood_type) == 'A+' ? 'selected' : '' }}>A+</option>
                                <option value="A-" {{ old('blood_type', $medicalRecord->blood_type) == 'A-' ? 'selected' : '' }}>A-</option>
                                <option value="B+" {{ old('blood_type', $medicalRecord->blood_type) == 'B+' ? 'selected' : '' }}>B+</option>
                                <option value="B-" {{ old('blood_type', $medicalRecord->blood_type) == 'B-' ? 'selected' : '' }}>B-</option>
                                <option value="AB+" {{ old('blood_type', $medicalRecord->blood_type) == 'AB+' ? 'selected' : '' }}>AB+</option>
                                <option value="AB-" {{ old('blood_type', $medicalRecord->blood_type) == 'AB-' ? 'selected' : '' }}>AB-</option>
                                <option value="O+" {{ old('blood_type', $medicalRecord->blood_type) == 'O+' ? 'selected' : '' }}>O+</option>
                                <option value="O-" {{ old('blood_type', $medicalRecord->blood_type) == 'O-' ? 'selected' : '' }}>O-</option>
                            </select>
                            @error('blood_type')
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="number" name="height" id="height" step="0.1" min="50" max="300"
                                   value="{{ old('height', $medicalRecord->height) }}" placeholder="e.g., 170"
                                   class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                            @error('height')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <input type="number" name="weight" id="weight" step="0.1" min="20" max="500"
                                   value="{{ old('weight', $medicalRecord->weight) }}" placeholder="e.g., 65"
                                   class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                            @error('weight')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        {{-- BMI Display --}}
                        <div id="bmi-display" class="{{ $medicalRecord->height && $medicalRecord->weight ? '' : 'hidden' }} sm:col-span-full lg:col-span-1 lg:col-start-3 p-4 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200">
                            <div class="text-center">
                                <div class="text-xs font-semibold text-blue-600 uppercase tracking-wide mb-1">Your BMI</div>
                                <div class="text-2xl sm:text-3xl font-bold text-blue-600 mb-1" id="bmi-value">
                                    @php
                                        $bmi = $medicalRecord->calculateBMI();
                                    @endphp
                                    {{ $bmi ? number_format($bmi, 1) : '' }}
                                </div>
                                <div class="text-xs font-medium text-blue-500 px-2 py-1 bg-blue-100 rounded-full" id="bmi-category">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="allergies" id="allergies" rows="3"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                      placeholder="e.g., Penicillin, Peanuts, Bee stings">{{ old('allergies', $medicalRecord->allergies) }}</textarea>
                            @error('allergies')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="past_illnesses" id="past_illnesses" rows="3"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                      placeholder="e.g., Asthma, Diabetes, Hepatitis B">{{ old('past_illnesses', $medicalRecord->past_illnesses) }}</textarea>
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl">
                                <div class="flex items-start space-x-3">
                                    <input type="checkbox" name="has_been_pregnant" id="has_been_pregnant" value="1"
                                           {{ old('has_been_pregnant', $medicalRecord->has_been_pregnant) ? 'checked' : '' }}
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl">
                                <div class="flex items-start space-x-3">
                                    <input type="checkbox" name="has_undergone_surgery" id="surgery_checkbox" value="1"
                                           {{ old('has_undergone_surgery', $medicalRecord->has_undergone_surgery) ? 'checked' : '' }}
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl">
                                <div class="flex items-start space-x-3">
                                    <input type="checkbox" name="is_taking_maintenance_drugs" id="maintenance_checkbox" value="1"
                                           {{ old('is_taking_maintenance_drugs', $medicalRecord->is_taking_maintenance_drugs) ? 'checked' : '' }}
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl">
                                <div class="flex items-start space-x-3">
                                    <input type="checkbox" name="has_been_hospitalized_6_months" id="hospitalization_checkbox" value="1"
                                           {{ old('has_been_hospitalized_6_months', $medicalRecord->has_been_hospitalized_6_months) ? 'checked' : '' }}
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl sm:col-span-2">
                                <div class="flex items-start space-x-3">
                                    <input type="checkbox" name="is_pwd" id="pwd_checkbox" value="1"
                                           {{ old('is_pwd', $medicalRecord->is_pwd) ? 'checked' : '' }}
                        ...
                        {{-- Conditional Fields --}}
                        {{-- Surgery Details --}}
                        <div id="surgery_details_div" class="{{ old('has_undergone_surgery', $medicalRecord->has_undergone_surgery) ? '' : 'hidden' }} transition-all duration-300">
                            ...
                            <textarea name="surgery_details" id="surgery_details" rows="2"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                      placeholder="e.g., Appendectomy in 2022">{{ old('surgery_details', $medicalRecord->surgery_details) }}</textarea>
                        ...
                        <div id="maintenance_drugs_div" class="{{ old('is_taking_maintenance_drugs', $medicalRecord->is_taking_maintenance_drugs) ? '' : 'hidden' }} transition-all duration-300">
                            ...
                            <textarea name="maintenance_drugs_specify" id="maintenance_drugs_specify" rows="2"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                      placeholder="e.g., Losartan, Metformin">{{ old('maintenance_drugs_specify', $medicalRecord->maintenance_drugs_specify) }}</textarea>
                        ...
                        <div id="hospitalization_details_div" class="{{ old('has_been_hospitalized_6_months', $medicalRecord->has_been_hospitalized_6_months) ? '' : 'hidden' }} transition-all duration-300">
                            ...
                            <textarea name="hospitalization_details_6_months" id="hospitalization_details_6_months" rows="2"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                      placeholder="e.g., Dengue Fever, November 2023">{{ old('hospitalization_details_6_months', $medicalRecord->hospitalization_details_6_months) }}</textarea>
                        ...
                        {{-- PWD Details --}}
                        <div id="pwd_details_div" class="{{ old('is_pwd', $medicalRecord->is_pwd) ? '' : 'hidden' }} grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 transition-all duration-300">
                            <div>
                                ...
                                <input type="text" name="pwd_id" id="pwd_id"
                                       value="{{ old('pwd_id', $medicalRecord->pwd_id) }}"
                                       class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                @error('pwd_id')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <textarea name="pwd_reason" id="pwd_reason" rows="2"
                                          class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                          placeholder="e.g., Visual impairment, mobility issues">{{ old('pwd_reason', $medicalRecord->pwd_reason) }}</textarea>
                                @error('pwd_reason')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes_health_problems" id="notes_health_problems" rows="3"
                                      class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base resize-vertical"
                                      placeholder="e.g., History of migraines, mild scoliosis">{{ old('notes_health_problems', $medicalRecord->notes_health_problems) }}</textarea>
            ...
            <div class="medical-card bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-4 sm:p-6">
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 p-4 rounded-xl">
                            <div class="flex items-start space-x-3">
                                <input type="checkbox" name="is_fully_vaccinated" id="is_fully_vaccinated" value="1"
                                       {{ old('is_fully_vaccinated', $medicalRecord->is_fully_vaccinated) ? 'checked' : '' }}
                        ...
                        {{-- Vaccination Details --}}
                        <div id="vaccination_details" class="{{ old('is_fully_vaccinated', $medicalRecord->is_fully_vaccinated) ? '' : 'hidden' }} space-y-4 transition-all duration-300">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                <div>
                                ...
                                <div>
                                    ...
                                    <input type="date" name="vaccine_date" id="vaccine_date" 
                                           value="{{ old('vaccine_date', $medicalRecord->vaccine_date ? $medicalRecord->vaccine_date->format('Y-m-d') : '') }}"
                                           class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                    @error('vaccine_date')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                                <div>
                                    ...
                                    <select name="number_of_doses" id="number_of_doses"
                                            class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                        <option value="N/A" {{ old('number_of_doses', $medicalRecord->number_of_doses) == 'N/A' ? 'selected' : '' }}>Not Applicable</option>
                                        ...
                                        <option value="3 doses" {{ old('number_of_doses', $medicalRecord->number_of_doses) == '3 doses' ? 'selected' : '' }}>3 doses</option>
                                    </select>
                                ...
                                <div class="bg-gray-50 p-4 rounded-xl">
                                    <div class="flex items-start space-x-3">
                                        <input type="checkbox" name="has_received_booster" id="has_received_booster" value="1"
                                               {{ old('has_received_booster', $medicalRecord->has_received_booster) ? 'checked' : '' }}
                            ...
                            {{-- Booster Details --}}
                            <div id="booster_details" class="{{ old('has_received_booster', $medicalRecord->has_received_booster) ? '' : 'hidden' }} grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 transition-all duration-300">
                                <div>
                                    <label for="number_of_boosters" class="block text-sm font-medium text-gray-700 mb-2">Number of Boosters</label>
                                    <select name="number_of_boosters" id="number_of_boosters"
                                            class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                        ...
                                        <option value="3 doses" {{ old('number_of_boosters', $medicalRecord->number_of_boosters) == '3 doses' ? 'selected' : '' }}>3 doses</option>
                                    </select>
                                ...
                                <div>
                                    ...
                                    <select name="booster_type" id="booster_type" 
                                        ...
                                        <option value="None" {{ old('booster_type', $medicalRecord->booster_type) == 'None' ? 'selected' : '' }}>None</option>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="emergency_contact_name_1" id="emergency_contact_name_1" 
                                           value="{{ old('emergency_contact_name_1', $medicalRecord->emergency_contact_name_1) }}" required
                                           class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="emergency_contact_number_1" id="emergency_contact_number_1" 
                                           value="{{ old('emergency_contact_number_1', $medicalRecord->emergency_contact_number_1) }}" required
                                ...
                                <div>
                                    ...
                                    <select name="emergency_contact_relationship_1" id="emergency_contact_relationship_1" required
                                        ...
                                        <option value="parent" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'parent' ? 'selected' : '' }}>Parent</option>
                                        <option value="mother" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'mother' ? 'selected' : '' }}>Mother</option>
                                        <option value="father" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'father' ? 'selected' : '' }}>Father</option>
                                        <option value="spouse" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'spouse' ? 'selected' : '' }}>Spouse</option>
                                        <option value="sibling" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'sibling' ? 'selected' : '' }}>Sibling</option>
                                        <option value="child" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'child' ? 'selected' : '' }}>Child</option>
                                        <option value="guardian" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'guardian' ? 'selected' : '' }}>Guardian</option>
                                        <option value="friend" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'friend' ? 'selected' : '' }}>Friend</option>
                                        <option value="other" {{ old('emergency_contact_relationship_1', $medicalRecord->emergency_contact_relationship_1) == 'other' ? 'selected' : '' }}>Other Relative</option>
                                    </select>
                            ...
                            <div class="space-y-4">
                                <div>
                                    ...
                                    <input type="text" name="emergency_contact_name_2" id="emergency_contact_name_2" 
                                           value="{{ old('emergency_contact_name_2', $medicalRecord->emergency_contact_name_2) }}"
                                           class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="emergency_contact_number_2" id="emergency_contact_number_2" 
                                           value="{{ old('emergency_contact_number_2', $medicalRecord->emergency_contact_number_2) }}"
                                           placeholder="e.g., +63 912 345 6789"
                                           class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                ...
                                <div>
                                    ...
                                    <select name="emergency_contact_relationship_2" id="emergency_contact_relationship_2"
                                            class="w-full px-3 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 text-sm sm:text-base">
                                        <option value="">Select Relationship</option>
                                        <option value="parent" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'parent' ? 'selected' : '' }}>Parent</option>
                                        <option value="mother" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'mother' ? 'selected' : '' }}>Mother</option>
                                        <option value="father" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'father' ? 'selected' : '' }}>Father</option>
                                        <option value="spouse" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'spouse' ? 'selected' : '' }}>Spouse</option>
                                        <option value="sibling" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'sibling' ? 'selected' : '' }}>Sibling</option>
                                        <option value="child" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'child' ? 'selected' : '' }}>Child</option>
                                        <option value="guardian" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'guardian' ? 'selected' : '' }}>Guardian</option>
                                        <option value="friend" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'friend' ? 'selected' : '' }}>Friend</option>
                                        <option value="other" {{ old('emergency_contact_relationship_2', $medicalRecord->emergency_contact_relationship_2) == 'other' ? 'selected' : '' }}>Other Relative</option>
                                    </select>
            ...
            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6">
                <a href="{{ route('student.medical-records.show', $medicalRecord) }}" 
                   class="order-2 sm:order-1 bg-white text-gray-700 border border-gray-300 hover:bg-gray-50 font-medium py-3 px-6 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md text-center">
                    Cancel
                </a>
                <button type="submit" class="order-1 sm:order-2 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium py-3 px-8 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center">
...
<script>
    ...
    function toggleVaccinationDetails() {
        const checkbox = document.getElementById('is_fully_vaccinated');
        const details = document.getElementById('vaccination_details');
        if (checkbox.checked) {
    ...
    function toggleSurgeryDetails() {
        const checkbox = document.getElementById('surgery_checkbox');
        const details = document.getElementById('surgery_details_div');
        if (checkbox.checked) {
            details.classList.remove('hidden');
            setTimeout(() => details.style.opacity = '1', 10);
        } else {
    ...
    function toggleMaintenanceDrugs() {
        const checkbox = document.getElementById('maintenance_checkbox');
        const details = document.getElementById('maintenance_drugs_div');
        if (checkbox.checked) {
            details.classList.remove('hidden');
            setTimeout(() => details.style.opacity = '1', 10);
        } else {
    ...
    function toggleHospitalization() {
        const checkbox = document.getElementById('hospitalization_checkbox');
        const details = document.getElementById('hospitalization_details_div');
        if (checkbox.checked) {
            details.classList.remove('hidden');
            setTimeout(() => details.style.opacity = '1', 10);
        } else {
    ...
    function togglePWDDetails() {
        const checkbox = document.getElementById('pwd_checkbox');
        const details = document.getElementById('pwd_details_div');
        if (checkbox.checked) {
            details.classList.remove('hidden');
            setTimeout(() => details.style.opacity = '1', 10);
        } else {
    ...
    function toggleBoosterDetails() {
        const checkbox = document.getElementById('has_received_booster');
        const details = document.getElementById('booster_details');
        if (checkbox.checked) {
            details.classList.remove('hidden');
            setTimeout(() => details.style.opacity = '1', 10);
        } else {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Initialize conditional fields with smooth transitions
        ...
        // Add smooth transitions to conditional fields
