...
return [
    ...
    | any of the connections defined in the array below, or set it to null
    | to use the null broadcaster.
    |
    | Supported: "pusher", "ably", "redis", "log", "null"
    |
    */

    'default' => env('BROADCAST_DRIVER', 'log'), // Changed to 'log' as fallback
    ...
    'connections' => [
        ...
        'pusher' => [
            ...
            'options' => [
                ...
                // COMMENT OUT OR REMOVE THE CURL OPTIONS:
                // 'curl_options' => [
